...
SECRET_KEY = 'django-insecure-3!hwb16_uj-44ejr7551zpeclbgoq(!y4ewa0zp5)zr$9e=0+b'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'fifths_task', 'templates'),
        ],
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),  # corrected
    }
}
